...
def get_hls_relaxed_extension_args() -> list[str]:
    """
    ...
    Must be passed as input arguments, ahead of the playlist ``-i``.
    """
...
async def check_ffmpeg_version() -> None:
    ...
    # which builds from git report as e.g. "N-121037-g1234567". The relaxation can be dropped
    # once MINIMAL_FFMPEG_VERSION reaches 7.1.2.
